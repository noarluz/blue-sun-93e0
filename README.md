...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/blue-sun-93e0)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/blue-sun-93e0
```

A live public deployment of this template is available at [https://blue-sun-93e0.templates.workers.dev](https://blue-sun-93e0.templates.workers.dev)
